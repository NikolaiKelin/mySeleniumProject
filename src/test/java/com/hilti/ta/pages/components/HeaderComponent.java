...
public class HeaderComponent extends PageObject {
	...
	private static final String CATEGORY_NAVIGATION_ITEM_PATTERN = "//li[contains(@class,'m-nav-secondary-stage-item is-active')]//a/span[contains(text(), '%s')]";
	...
	private final By productNavigation = By.xpath("//li[contains(@class,'m-nav-secondary-stage-item is-active')]");
	...
	public void verifyCategoryIsPresentInProductNavigation(final String categoryName) {
		...
		Assert.assertTrue(webElement.isDisplayed(),
				String.format("Web element not visible for locator: %s", categoryNavigationItem));
	}
